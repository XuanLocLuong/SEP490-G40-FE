...
const CandidateSettingsPage = () => {
    ...
    const handleModalSave = async () => {
        ...
        try {
            ...
            if (editModal === 'email') {
                setModalError(getAuthErrorMessage(err));
            } else {
                    ...
                    <div className="account-settings__card account-settings__personal-card">
                        ...
                        <div className="account-settings__personal-layout">
                            <div className="account-settings__avatar-column">
                                <div
                                    className={`account-settings__avatar-picker${hasProfilePicture(user.profilePicture)
                                ...
                                <label
                                    className={`account-settings__avatar-change-link${avatarLoading ? ' account-settings__avatar-change-link--disabled' : ''
                                        }`}
                                >
                            ...
                            <div className="account-settings__fields-grid">
                                ...
                                <div className="account-settings__form-field account-settings__field-full">
                                    ...
                                    <div className="account-settings__email-row">
                                        ...
                                        />
                                        <span
                                            className={`account-settings__verify-badge${user.emailVerified
                                        ...
                                        {!user.googleLinked ? (
                                            ...
                                            >
                                                {user.emailVerified ? 'Thay đổi →' : 'Xác thực email →'}
                                            </button>
                                        ) : (
                                            <span
                                                className="account-settings__field-hint"
                                                title="Tài khoản đăng nhập Google — email do Google quản lý"
                                            >
                                                Email Google
                                            </span>
                                        )}
                                    ...
                                    {user.googleLinked && (
                                        <p className="account-settings__field-hint">
                                            Bạn đăng nhập bằng Google nên không thể đổi email tại đây.
                                        </p>
                                    )}
                                </div>
                            </div>
